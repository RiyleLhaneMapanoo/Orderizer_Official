...
using Ord_Data;
using Ord_Business;
using Ord_EmailIntegration;

namespace Ord_ConsoleUI
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Setup
            IOrd_DataService dataService = new Ord_InMemory();
            Ord_BusinessServ businessServ = new Ord_BusinessServ(dataService);
            IEmailService emailService = new MailTrapService();
            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    ...
                    case "5":
                        return;
                    case "6":
                        SendBestDealsEmail(businessServ, emailService);
                        break;
                    default:
        ...
        static void SendBestDealsEmail(Ord_BusinessServ businessServ, IEmailService emailService)
        {
            ...
            string bodyHtml = "<h2>🛍 OrderIZER Best Deals</h2><ul>";
            ...
            bodyHtml += "</ul><p><i>Generated on " + DateTime.Now.ToString("f") + "</i></p>";

            string to = "test@example.com"; // Use your Mailtrap test email
            string subject = "🛒 OrderIZER Weekly Best Deals";

            Console.WriteLine("📨 Sending email summary...");
            emailService.SendEmail(to, subject, bodyHtml);
            Console.WriteLine("✅ Best deals summary sent! Check your Mailtrap inbox.");
        }
